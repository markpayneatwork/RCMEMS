...
#' script <- 'python -m motuclient --motu http://my.cmems-du.eu/motu-web/Motu --service-id SST_GLO_SST_L4_REP_OBSERVATIONS_010_011-TDS --product-id METOFFICE-GLO-SST-L4-RAN-OBS-SST --longitude-min -179.97500610351562 --longitude-max 179.97500610351562 --latitude-min -89.9749984741211 --latitude-max 89.9749984741211 --date-min "2007-12-26 12:00:00" --date-max "2007-12-31 12:00:00" --variable analysed_sst --variable analysis_error --out-dir <OUTPUT_DIRECTORY> --out-name <OUTPUT_FILENAME> --user <USERNAME> --pwd <PASSWORD> '
#' cfg <- parse.CMEMS.script(script)
#' cfg
#' #We can easily update some of the elements using update:
#' cfg2 <- update(cfg,out.dir="data",out.name="SST.nc")
#' cfg2
#' 
